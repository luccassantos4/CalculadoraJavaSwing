package github.luccassantos4.calc.visao;
...
import github.luccassantos4.calc.modelo.Memoria;
...
public class Teclado extends JPanel implements ActionListener {
	...
	public Teclado() {
		...
		setLayout(layout);
		c.weightx = 1; //preenche o eixo x
		c.weighty = 1; //preenche o eixo y
